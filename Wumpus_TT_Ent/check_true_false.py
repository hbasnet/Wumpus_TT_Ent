...
def main(argv):
    ...
    print
    ##################################################################################
    # coded added below here

    # collected unique symbol has one empty string at first
    symbol_collection.pop(0)
    # just printing all symbols

    print('unique symbols')
    print(symbol_collection)
    print

    print('Recursion of entails1')
    entails1 = tt_entails(knowledge_base, statement)
    print('Return for entails1')
    print(entails1)
    print

    negstatement = logical_expression()
    negstatement.connective[0] = 'not'
    negstatement.subexpressions.append(statement)

    # Show us what the negstatement is
    print '\nChecking negstatement: ',
    print_expression(negstatement, '')
    print

    print('Recursion of entails2')
    entails2 = tt_entails(knowledge_base, negstatement)
    print('Return for entails2')
    print(entails2)

    check_true_false(entails1, entails2)
    # code added till here in main
    ##################################################################################
    sys.exit(1)
